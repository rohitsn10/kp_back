...
class DocumentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id','documentname', 'documentnumber','project','revision_number','keywords','confidentiallevel','status','comments','document_attachments','created_by','created_at','updated_at']