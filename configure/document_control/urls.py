...
urlpatterns = [
    ...
    path('document_management/<int:document_id>', DocumentViewSet.as_view({'get':'list'}), name='document_list'),
    path('document_management_update/<int:document_id>', DocumentUpdateViewSet.as_view({'put':'update','delete':'destroy'}), name='document'),
