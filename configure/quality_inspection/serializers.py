...
class QualityInspectionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'project', 'items', 'vendor','cpp_ipp', 'is_venodr_verified', 'mqap_upload', 'quality_dossier_upload', 'drawing_upload', 'data_sheet_upload', 
                'specification_upload', 'mdcc_upload', 'inspection_status', 'inspection_date', 'mqap_revision_number', 'mqap_revision_status',
                'quality_dossier_revision_number', 'quality_dossier_revision_status', 'drawing_revision_number', 'drawing_revision_status',
                'data_sheet_revision_number', 'data_sheet_revision_status', 'specification_revision_number', 'specification_revision_status',
                'mdcc_revision_number', 'mdcc_revision_status', 'remarks',
