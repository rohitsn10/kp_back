...
class ProjectProgressRemark(models.Model):
    project_progress = models.ForeignKey(
        'ProjectProgress', 
        on_delete=models.CASCADE, 
        related_name="progress_remarks"
    )
    ...
    def __str__(self):
        return f"Remark by {self.user.full_name if self.user else 'Unknown'} on {self.project_progress.particulars}"
