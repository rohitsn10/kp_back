...
urlpatterns = [
    ...
    path('get_all_project_wise_punch_raise_completed_verify', GetAllProjectWisePunchRaiseCompletedVerifyViewSet.as_view({'get': 'list'}), name='get_all_project_wise_punch_raise_completed_verify'),
