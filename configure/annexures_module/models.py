...
class MockDrillReport(models.Model):
    ...
    team_leader_incident_controller = models.CharField(max_length=255,choices=TEAM_LEADER_CHOICES, blank=True, null=True)
    performance = models.CharField(max_length=255,choices=PERFORMANCE_CHOICES, blank=True, null=True)
    traffic_or_evacuation = models.CharField(max_length=255, choices=TRAFFIC_CHOICES, blank=True, null=True)
    ambulance_first_aid_ppe_rescue = models.CharField(max_length=255, choices=AMBULANCE_CHOICES, blank=True, null=True)
